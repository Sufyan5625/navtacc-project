...
const Form = () => {
  return (
    <>
    <section class="text-black bg-cover bg-no-repeat bg-center bg-[url(https://images.unsplash.com/photo-1516975080664-ed2fc6a32937?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGNvc21ldGljfGVufDB8fDB8fHww)] body-font relative">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-black">Contact Us</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-black">We'd Love to Hear from You</p>
    </div>
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
          <a class="text-indigo-400">Arwasworld@gmail.com</a>
          <p class="leading-normal my-5">Gulshan e Maymar
            <br/>Karachi Pakistan.
          </p>

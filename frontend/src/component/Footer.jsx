...
const Footer = () => {
  return (
    <>
    <footer className="text-gray-600 bg-red-200 body-font">
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
      ...
      <img src={logo1} alt="" className='w-20 h-20 text-white rounded-full p-2 bg-green'/>
        <span className="ml-3 text-xl">Arwa's Cosmetics & Jewels</span>
      </a>
      <p className="mt-2 text-sm text-gray-500">Your Journey to Radiance Starts here</p>
    </div>
    <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Sarch</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Term of service</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Return policy</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Summer sale 2024</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">Exchange and return policy</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Accounts</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">03350231210</a>
          </li>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 Arwa's Beauty World —
